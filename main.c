...
int main()
{
    ...
    // 开机流水灯：绿→蓝→黄→红
    led_blink(LED_GREEN,  200); delay_us(100000);
    led_blink(LED_BLUE,   200); delay_us(100000);
    led_blink(LED_YELLOW, 200); delay_us(100000);
    led_blink(LED_RED,    200); delay_us(200000);
    // 全部闪一下
    led_on(LED_ALL);  delay_us(150000);
    led_off(LED_ALL); delay_us(100000);
